...
const Navbar = () => {
    ...
    return (
        ...
        <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b-4 border-cyan-800">
            <div className="container mx-auto px-4 py-3">
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <nav className="flex flex-wrap items-center gap-4">
                        <Link to='/' className="text-gray-300 hover:text-cyan-400 transition duration-300 ease-in-out">
                            Home
                        </Link>
                        {user && (
